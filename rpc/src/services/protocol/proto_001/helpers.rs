...
impl RightsConstants {
    ...
    pub(crate) fn parse_rights_constants(context_proto_param: ContextProtocolParam) -> Result<Self, failure::Error> {
        let dynamic = tezos_messages::protocol::proto_001::constants::ParametricConstants::from_bytes(context_proto_param.constants_data)?;
...
impl RightsContextData {
    ...
    fn get_context_rolls(context: &TezedgeContext, requested_level: usize, cycle: i64, snapshot: i16) -> Result<Option<HashMap<i32, String>>, failure::Error> {
        ...
        // TODO: shouldn't there be slashes after snapshot?
