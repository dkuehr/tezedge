...
#[test]
fn can_deserialize_nom_operations_for_blocks_right() -> Result<(), Error> {
    let message_bytes = hex::decode("000000660061b12238a7c3577d725939970800ade6b82d94a231e855b46af46c37850dd02452030ffe7601035ca2892f983c10203656479cfd2f8a4ea656f300cd9d68f74aa625870f7c09f7c4d76ace86e1a7e1c7dc0a0c7edcaa8b284949320081131976a87760c300")?;
    let messages = PeerMessageResponse::nom_from_bytes(message_bytes)?;
    assert_eq!(1, messages.messages().len());
...
#[test]
fn can_deserialize_nom_operations_for_blocks_left() -> Result<(), Error> {
    let message_bytes = hex::decode("")?;
    let messages = PeerMessageResponse::nom_from_bytes(message_bytes)?;
    assert_eq!(1, messages.messages().len());
...
#[test]
fn can_deserialize_nom_operations_for_blocks_zig_zag() -> Result<(), Error> {
    ...
    match message {
        PeerMessage::OperationsForBlocks(message) => {
            assert_eq!("BMWmj9CTojf7AnA8ZQFWGkh1cXB6FkST8Ey5coaeHX6cVNAZqA6", HashType::BlockHash.bytes_to_string(message.operations_for_block().hash()));
                ...
                Path::Left(path) => {
                    ...
                    match path.path() {
                        Path::Right(path) => {
                            ...
                            match path.path() {
                                Path::Left(path) => {
                                    assert_eq!("LLoZi3xywrX9swZQgC82m7vj5hmuz6LGAatNq2Muh34oNn71JruZs", HashType::OperationListListHash.bytes_to_string(path.right()));
                                    match path.path() {
                                        Path::Right(path) => {
                                            assert_eq!("LLoaGLRPRx3Zf8kB4ACtgku8F4feeBiskeb41J1ciwfcXB3KzHKXc", HashType::OperationListListHash.bytes_to_string(path.left()));
                                            match path.path() {
                                ...
                                _ => panic!("Unexpected path: {:?}. Was expecting Path::Left.", path)
                            }
                        },
                        _ => panic!("Unexpected path: {:?}. Was expecting Path::Right.", path)
                    }
                },
                _ => panic!("Unexpected path: {:?}. Was expecting Path::Left.", message.operation_hashes_path())
            }
        },
        _ => panic!("Unsupported encoding: {:?}", message)
    }
